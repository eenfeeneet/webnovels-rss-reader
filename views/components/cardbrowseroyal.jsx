...
class CardBrowseRoyal extends React.Component {
  render() {
    ...
    if(data.novels === false){
        ...
        royalList = data.novels.map(novel=>{
                    ...
                    <div className="card bg-light text-dark my-2">
                        <div className="panel-group">
                            <div className="panel panel-default">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    <a role="button" href="" className="btn" data-toggle="collapse" data-target="#collapseUploads"><h5 className="mb-0 text-dark"> Royal Road </h5></a>
...
module.exports = CardBrowseRoyal;